...
import { loginThunkCreatorSlice } from "../../state/authSlice";
...
// debugger
  const onSubmit = (values, form) => {
    ...
    // loginThunkCreatorSlice(values.login, values.password, values.rememberMe)
    // form.reset();
  ...
  return (
    <>
      <div className={styles.loginPage}>
        ...
        <LoginForm login={props.loginThunkCreatorSlice} error={props.error} />
      </div>
    </>
  );
};
...
export default connect(mapStateToProps, {loginThunkCreatorSlice})(LoginFinal);//вот эта строка решила все
